                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-4 pt-5">
                            <h2 className="h2 text-success border-bottom pb-3 border-light logo">World Class Diamond</h2>
            ...
            {/* <div classNameName="Footer">
                <div classNameName="container">
                    <div classNameName="row">
                        <div classNameName="col-md-6 col-lg-5 col-12 ft-1">
                        ...
                        <div classNameName="col-md-6 col-lg-3 col-12 ft-2">
                            <h5>Quick Links</h5>
                            <ul>
                                <li classNameName="nav-item">
                                    <a classNameName="" href="/">Services</a>
                                </li>
                                <li classNameName="nav-item">
                                    <a classNameName="" href="/">Portfolio</a>
                                </li>
                                <li classNameName="nav-item">
                                    <a classNameName="" href="/">Contact Us</a>
                                </li>
                                <li classNameName="nav-item">
                                    <a classNameName="" href="/">Services</a>
                                </li>
                        ...
                        <div classNameName="col-md-6 col-lg-4 col-12 ft-3">
                            <h5>Quick Links</h5>
